...
\begin{shaded}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \filldraw (-0.75,0) circle (0.05);
            \filldraw (-0.45,0) circle (0.05);
            \filldraw (0.75,0) circle (0.05);
            \filldraw (0.45,0) circle (0.05);
            \filldraw (0.15,0) circle (0.05);
            \filldraw (-0.15,0) circle (0.05);
            \draw[-] (-0.75,-0.125)--node[below]{10 cm}(-0.45,-0.125);
            \centerarc[->,draw=black](0,0.5)(120:420:0.1667) node[above]{Rotation axis};
        \end{tikzpicture}
    \end{center}
    \begin{enumerate}
