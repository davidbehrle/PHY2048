...
\begin{shaded}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.78]
            ...
            %%% FORCES %%%
            \draw[->,ultra thick,-latex,draw=black!10!red] (m1)--node[above,xshift=-5mm]{$\vec{F}_1 = -6.0\hat{i}\text{ N}$}(-3.5,1);
...
\newpage
\begin{shaded}
    \underline{\bf{Example 11.7:} Coupled Flywheels}
    \vspace{2mm}\\
    A flywheel rotates without friction at an angular velocity $\omega_0 = 600$ rev/min on a frictionless vertical shaft of negligible rotational inertia. A second flywheel, which is at rest and has a moment of inertia three times that of the rotating flywheel, is dropped onto it. Because friction exists between the surfaces, the flywheels very quickly reach the same rotational velocity, after which they spin together.
    \begin{center}
        \begin{tikzpicture}
            %%% BOTTOM %%%
            \filldraw[black!60] (-0.1,0) rectangle (0.1,-1);
            \draw[black!75,thick] (0,-1.015) ellipse (0.1 and 0.05);
            \filldraw[black!60] (0,-1) ellipse (0.1 and 0.05);
            \draw[line width=0.625pt,black!75] (0.1,-0.5)--(0.1,-1.02);
            \draw[line width=0.625pt,black!75] (-0.1,-0.5)--(-0.1,-1.02);

            \filldraw[black!60] (0,0) ellipse (1 and 0.5);
            \draw[black!75,very thick] (0,0) ellipse (1 and 0.5);
            \filldraw[black!75] (0,0) ellipse (1pt and 0.5pt);
            \node[yshift=-1mm] at (0,-1.02){\AxisRotator[x=0.2cm,y=0.4cm,rotate=-90]};

            \node at ({1.1*cos(45)},{1.1*sin(45) - 0.2}){$l_0$};
            %%% TOP %%%
            \filldraw[black!60] (0,1.2) ellipse (1 and 0.5);
            \draw[black!75,very thick] (0,1.2) ellipse (1 and 0.5);
            \draw[black!75,thick] (0,1.2) ellipse (0.1 and 0.05);
            \filldraw[black!60] (-0.1,1.2) rectangle (0.1,2.2);
            \filldraw[black!60] (0,2.2) ellipse (0.1 and 0.05);
            \draw[black!75,thick] (0,2.2) ellipse (0.1 and 0.05);
            \draw[line width=0.625pt,black!75] (0.1,2.2)--(0.1,1.2);
            \draw[line width=0.625pt,black!75] (-0.1,2.2)--(-0.1,1.2);

            \node at ({1.1*cos(45)},{1.1*sin(45) + 1.2}){$3l_0$};
        \end{tikzpicture}
        \hspace{10mm}
        \begin{tikzpicture}
            \filldraw[black!60] (-0.1,0) rectangle (0.1,-1);
            ...
            \draw[black!75,thick] (0,0) ellipse (0.1 and 0.05);
            \filldraw[black!60] (-0.1,0) rectangle (0.1,1);
            \filldraw[black!60] (0,1) ellipse (0.1 and 0.05);
            \draw[black!75,thick] (0,1) ellipse (0.1 and 0.05);
            \draw[line width=0.625pt,black!75] (0.1,1)--(0.1,0);
            \draw[line width=0.625pt,black!75] (-0.1,1)--(-0.1,0);
