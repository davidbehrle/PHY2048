...
\begin{multicols*}{3}
    ...
    \begin{tikzpicture}
        \node[mybox] (box){
        \begin{minipage}{0.25\textwidth}
            \bf{Time of flight:} $\displaystyle T = \frac{2v_0\sin(\theta_0)}{g}$\\
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            $W_f = \mu_kNd = \mu_kmgd$\\
            \bf{(}\boldmath{$F_{cons}$}\unboldmath\bf{, closed path)}\\
            $\displaystyle W = \oint \vec{F} \cdot d\vec{r} = 0\ $
        \end{minipage}
        };
        \draw[-] (-2.75,-1.2)--(2.75,-1.2);
    ...
    \begin{tikzpicture}
        \node[mybox] (box){
        \begin{minipage}{0.25\textwidth}
            $\displaystyle K_t = \frac{1}{2}mv^2 = \frac{p^2}{2m}$\vspace{1mm}\\
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            \vspace{1mm}
            $K_A + U_A =  K_B + U_B$\hspace{1.5mm} (if $W_{nc} = 0$)\\
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            $\displaystyle M\vec{v}_{cm} = \sum_{j = 1}^{N}m_j\vec{v}_j$\vspace{1.2mm}\\
            \bf{Continuous object:}\\
            $\displaystyle \vec{r}_{cm} = \frac{1}{M}\int\vec{r}dm$
        \end{minipage}
        };
        \draw[-] (-2.75,-1.3)--(2.75,-1.3);
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            $\displaystyle \omega = \frac{v_t}{r} = \der{\theta}{t}$ \hspace{8mm}$\displaystyle \alpha = \frac{a_t}{r} = \der{\omega}{t}$
