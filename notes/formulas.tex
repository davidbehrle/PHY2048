...
\begin{multicols*}{3}
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            \boldmath{$\vec{F}_{con}$}\bf{, closed path:}\\
            \unboldmath$\displaystyle W = \oint \vec{F} \cdot d\vec{r} = 0$
        \end{minipage}
        };
    ...
    \begin{tikzpicture}
        \node[mybox] (box){
        \begin{minipage}{0.25\textwidth}
            $\displaystyle I = \sum_{i} m_ir_i^2$\\
    ...
    \begin{tikzpicture}
        ...
        \begin{minipage}{0.25\textwidth}
            ...
            $\displaystyle W = \int\sum\vec{\tau} \cdot d\vec{\theta}$\\
            $\displaystyle W_{AB} = \int\limits_{\theta_a}^{\text{ }\theta_B}\bigg(\sum_{i}\tau_i\bigg)d\theta$
        \end{minipage}
        };
