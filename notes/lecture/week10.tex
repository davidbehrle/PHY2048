...
\begin{shaded}
    ...
    \begin{tikzpicture}
        \filldraw[black] (-1.5,0) circle (0.4);
        \filldraw[black] (1.5,0) circle (0.4);
        \draw[line width=1pt] (-1.1,0)--(1.1,0);
        \draw[->,thick,-latex,draw=red] (0,0)--(0,-1.2) node[below]{$F_c = 2F$};
        \draw[->,thick,-latex,draw=red] (-1.1,0)--(-1.1,0.8) node[above]{$F_a = F$};
        \draw[->,thick,-latex,draw=red] (0.55,0)--node[right]{$135\degree$}(0,0.55) node[above]{$F_b = F$};
        \draw (-{cos(60)},{cos(60)}) coordinate (a);
    \end{tikzpicture}
    \begin{enumerate}
